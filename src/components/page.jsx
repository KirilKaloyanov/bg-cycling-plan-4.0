    ...
    <Fragment>
      ...
      <div className="block_offset">
        ...
        <div className="text text_column">
          ...
          Дунавския регион. Резултатът от тази задача е пространствен модел на Схема на
          ...
          със съседните Дунавски страни и предложения за конкретни трасета на националните
          маршрути. 
          <br />
          <br />
          Можете да разгледате проект на&nbsp;  
          <a 
            href='http://www.baatbg.org/uploads/docs/DCP3-320-3.1/plan/DCP-NCP-2022-v16.pdf'
            target='_blank' 
            rel="noreferrer"
          >
            Националния велосипеден план
          </a>, както и&nbsp;  
          <a 
            href='http://www.baatbg.org/uploads/docs/DCP3-320-3.1/plan/DCP-NCP-summary.pdf'
            target='_blank' 
            rel="noreferrer"
          >резюме</a>
          . Окончателният документ заедно с приложенията към него ще бъде публикуван след приемането му от междуведомствената работна група. 
        </div>
      </div>
      <div className="block_offset">
